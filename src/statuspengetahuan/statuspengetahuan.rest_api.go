...
// RESTAPIHandler provides a convenient interface for StatusPengetahuan REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the StatusPengetahuan REST API handler.
...
// GetByID is the REST API handler for `GET /api/status_pengetahuan/{id}`.
...
// Get is the REST API handler for `GET /api/status_pengetahuan`.
...
// Create is the REST API handler for `POST /api/status_pengetahuan`.
...
// UpdateByID is the REST API handler for `PUT /api/status_pengetahuan/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/status_pengetahuan/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/status_pengetahuan/{id}`.
