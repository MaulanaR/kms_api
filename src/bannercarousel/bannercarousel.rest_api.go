...
// RESTAPIHandler provides a convenient interface for BannerCarousel REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the BannerCarousel REST API handler.
...
// GetByID is the REST API handler for `GET /api/banner_carousel/{id}`.
...
// Get is the REST API handler for `GET /api/banner_carousel`.
...
// Create is the REST API handler for `POST /api/banner_carousel`.
...
// UpdateByID is the REST API handler for `PUT /api/banner_carousel/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/banner_carousel/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/banner_carousel/{id}`.
