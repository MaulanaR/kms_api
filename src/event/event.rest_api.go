...
// GetByID is the REST API handler for `GET /api/events/{id}`.
...
// Get is the REST API handler for `GET /api/events`.
...
// Create is the REST API handler for `POST /api/events`.
...
// UpdateByID is the REST API handler for `PUT /api/events/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/events/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/events/{id}`.
