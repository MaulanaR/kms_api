...
// RESTAPIHandler provides a convenient interface for AdvisSumberData REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the AdvisSumberData REST API handler.
...
// GetByID is the REST API handler for `GET /api/advis_sumber_data/{id}`.
...
// Get is the REST API handler for `GET /api/advis_sumber_data`.
...
// Create is the REST API handler for `POST /api/advis_sumber_data`.
...
// UpdateByID is the REST API handler for `PUT /api/advis_sumber_data/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/advis_sumber_data/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/advis_sumber_data/{id}`.
