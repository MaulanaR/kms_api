...
// RESTAPIHandler provides a convenient interface for KelompokDokumen REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the KelompokDokumen REST API handler.
...
// GetByID is the REST API handler for `GET /api/kelompok_dokumen/{id}`.
...
// Get is the REST API handler for `GET /api/kelompok_dokumen`.
...
// Create is the REST API handler for `POST /api/kelompok_dokumen`.
...
// UpdateByID is the REST API handler for `PUT /api/kelompok_dokumen/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/kelompok_dokumen/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/kelompok_dokumen/{id}`.
