...
// Base is common detail of attachments open api document component.
func (o *OpenAPIOperation) Base() {
	o.Tags = []string{"Attachment"}
	o.HeaderParams = []map[string]any{{"$ref": "#/components/parameters/headerParam.Accept-Language"}}
	o.Responses = map[string]map[string]any{
		"200": {
			"description": "Success",
			"content":     map[string]any{"application/json": &Attachment{}}, // will auto create schema $ref: '#/components/schemas/Attachment' if not exists
		},
...
// Get is detail of `GET /api/v3/attachments` open api document component.
func (o *OpenAPIOperation) Get() *OpenAPIOperation {
	...
	o.Description = "Use this method to get list of Attachment"
	o.QueryParams = []map[string]any{{"$ref": "#/components/parameters/queryParam.Any"}}
	o.Responses = map[string]map[string]any{
		"200": {
			"description": "Success",
			"content":     map[string]any{"application/json": &AttachmentList{}}, // will auto create schema $ref: '#/components/schemas/Attachment.List' if not exists
		},
		"400": app.OpenAPIError().BadRequest(),
		"401": app.OpenAPIError().Unauthorized(),
		"403": app.OpenAPIError().Forbidden(),
...
// GetByID is detail of `GET /api/v3/attachments/{id}` open api document component.
func (o *OpenAPIOperation) GetByID() *OpenAPIOperation {
	...
	o.Base()
	o.Summary = "Get Attachment By ID"
	o.Description = "Use this method to get Attachment by id"
	o.PathParams = []map[string]any{{"$ref": "#/components/parameters/pathParam.ID"}}
	return o
}

// Create is detail of `POST /api/v3/attachments` open api document component.
func (o *OpenAPIOperation) Create() *OpenAPIOperation {
	...
	o.Base()
	o.Summary = "Create Attachment"
	o.Description = "Use this method to create Attachment"
	o.Body = map[string]any{"application/json": &ParamCreate{}}
	return o
}

// UpdateByID is detail of `PUT /api/v3/attachments/{id}` open api document component.
func (o *OpenAPIOperation) UpdateByID() *OpenAPIOperation {
	...
	o.Base()
	o.Summary = "Update Attachment By ID"
	o.Description = "Use this method to update Attachment by id"
	o.PathParams = []map[string]any{{"$ref": "#/components/parameters/pathParam.ID"}}
	o.Body = map[string]any{"application/json": &ParamUpdate{}}
	return o
}

// PartiallyUpdateByID is detail of `PATCH /api/v3/attachments/{id}` open api document component.
func (o *OpenAPIOperation) PartiallyUpdateByID() *OpenAPIOperation {
	...
	o.Base()
	o.Summary = "Partially Update Attachment By ID"
	o.Description = "Use this method to partially update Attachment by id"
	o.PathParams = []map[string]any{{"$ref": "#/components/parameters/pathParam.ID"}}
	o.Body = map[string]any{"application/json": &ParamPartiallyUpdate{}}
	return o
}

// DeleteByID is detail of `DELETE /api/v3/attachments/{id}` open api document component.
func (o *OpenAPIOperation) DeleteByID() *OpenAPIOperation {
	...
	o.Base()
	o.Summary = "Delete Attachment By ID"
	o.Description = "Use this method to delete Attachment by id"
	o.PathParams = []map[string]any{{"$ref": "#/components/parameters/pathParam.ID"}}
