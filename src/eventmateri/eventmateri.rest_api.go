...
// RESTAPIHandler provides a convenient interface for EventMateri REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the EventMateri REST API handler.
...
// GetByID is the REST API handler for `GET /api/event_materi/{id}`.
...
// Get is the REST API handler for `GET /api/event_materi`.
...
// Create is the REST API handler for `POST /api/event_materi`.
...
// UpdateByID is the REST API handler for `PUT /api/event_materi/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/event_materi/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/event_materi/{id}`.
