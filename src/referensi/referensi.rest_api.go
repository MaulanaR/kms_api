...
// RESTAPIHandler provides a convenient interface for Referensi REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the Referensi REST API handler.
...
// GetByID is the REST API handler for `GET /api/referensi/{id}`.
...
// Get is the REST API handler for `GET /api/referensi`.
...
// Create is the REST API handler for `POST /api/referensi`.
...
// UpdateByID is the REST API handler for `PUT /api/referensi/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/referensi/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/referensi/{id}`.
