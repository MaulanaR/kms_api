...
// RESTAPIHandler provides a convenient interface for Elibrary REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the Elibrary REST API handler.
...
// GetByID is the REST API handler for `GET /api/elibrary/{id}`.
...
// Get is the REST API handler for `GET /api/elibrary`.
...
// Create is the REST API handler for `POST /api/elibrary`.
...
// UpdateByID is the REST API handler for `PUT /api/elibrary/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/elibrary/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/elibrary/{id}`.
