...
// RESTAPIHandler provides a convenient interface for Pencapaian REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the Pencapaian REST API handler.
...
// GetByID is the REST API handler for `GET /api/pencapaian/{id}`.
...
// Get is the REST API handler for `GET /api/pencapaian`.
...
// Create is the REST API handler for `POST /api/pencapaian`.
...
// UpdateByID is the REST API handler for `PUT /api/pencapaian/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/pencapaian/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/pencapaian/{id}`.
