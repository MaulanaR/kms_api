...
// RESTAPIHandler provides a convenient interface for User REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the User REST API handler.
...
// GetByID is the REST API handler for `GET /api/user/{id}`.
...
// Get is the REST API handler for `GET /api/user`.
...
// Create is the REST API handler for `POST /api/user`.
...
// UpdateByID is the REST API handler for `PUT /api/user/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/user/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/user/{id}`.
