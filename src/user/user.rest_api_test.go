...
func prepareTest(tb testing.TB) {
	...
	app.Server().AddRoute("/user", "POST", REST().Create, nil)
	app.Server().AddRoute("/user", "GET", REST().Get, nil)
	app.Server().AddRoute("/user/:id", "GET", REST().GetByID, nil)
	app.Server().AddRoute("/user/:id", "PUT", REST().UpdateByID, nil)
	app.Server().AddRoute("/user/:id", "PATCH", REST().PartiallyUpdateByID, nil)
	app.Server().AddRoute("/user/:id", "DELETE", REST().DeleteByID, nil)
}
