...
// RESTAPIHandler provides a convenient interface for DokumenMap REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the DokumenMap REST API handler.
...
// GetByID is the REST API handler for `GET /api/dokumen_map/{id}`.
...
// Get is the REST API handler for `GET /api/dokumen_map`.
...
// Create is the REST API handler for `POST /api/dokumen_map`.
...
// UpdateByID is the REST API handler for `PUT /api/dokumen_map/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/dokumen_map/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/dokumen_map/{id}`.
