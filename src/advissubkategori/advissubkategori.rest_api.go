...
// RESTAPIHandler provides a convenient interface for AdvisSubKategori REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the AdvisSubKategori REST API handler.
...
// GetByID is the REST API handler for `GET /api/advis_sub_kategori/{id}`.
...
// Get is the REST API handler for `GET /api/advis_sub_kategori`.
...
// Create is the REST API handler for `POST /api/advis_sub_kategori`.
...
// UpdateByID is the REST API handler for `PUT /api/advis_sub_kategori/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/advis_sub_kategori/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/advis_sub_kategori/{id}`.
