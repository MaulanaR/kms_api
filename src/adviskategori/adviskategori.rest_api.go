...
// RESTAPIHandler provides a convenient interface for AdvisKategori REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the AdvisKategori REST API handler.
...
// GetByID is the REST API handler for `GET /api/advis_kategori/{id}`.
...
// Get is the REST API handler for `GET /api/advis_kategori`.
...
// Create is the REST API handler for `POST /api/advis_kategori`.
...
// UpdateByID is the REST API handler for `PUT /api/advis_kategori/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/advis_kategori/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/advis_kategori/{id}`.
