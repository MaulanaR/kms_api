...
func (o *OpenAPIOperation) Base() {
	...
	o.Responses = map[string]map[string]any{
		"200": {
			"description": "Success",
			"content":     map[string]any{"application/json": &AccessToken{}}, // will auto create schema $ref: '#/components/schemas/Referensi' if not exists
		},
...
func (o *OpenAPIOperation) Create() *OpenAPIOperation {
	...
	o.Base()
	o.Summary = "Login Session"
	o.Description = "Use this method to start login session"
