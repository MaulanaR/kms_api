...
// RESTAPIHandler provides a convenient interface for HistoryPoint REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the HistoryPoint REST API handler.
...
// GetByID is the REST API handler for `GET /api/history_points/{id}`.
...
// Get is the REST API handler for `GET /api/history_points`.
...
// Create is the REST API handler for `POST /api/history_points`.
...
// UpdateByID is the REST API handler for `PUT /api/history_points/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/history_points/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/history_points/{id}`.
