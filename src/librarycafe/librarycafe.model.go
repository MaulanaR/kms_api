...
type LibraryCafe struct {
	...
	WaktuMulai     app.NullInt64 `json:"waktu_mulai"         db:"m.waktu_mulai"                                                           gorm:"column:waktu_mulai"`
	WaktuSelesai   app.NullInt64 `json:"waktu_selesai"       db:"m.waktu_selesai"                                                         gorm:"column:waktu_selesai"`
