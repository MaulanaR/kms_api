...
// RESTAPIHandler provides a convenient interface for JenisPengetahuan REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the JenisPengetahuan REST API handler.
...
// GetByID is the REST API handler for `GET /api/jenis_pengetahuan/{id}`.
...
// Get is the REST API handler for `GET /api/jenis_pengetahuan`.
...
// Create is the REST API handler for `POST /api/jenis_pengetahuan`.
...
// UpdateByID is the REST API handler for `PUT /api/jenis_pengetahuan/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/jenis_pengetahuan/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/jenis_pengetahuan/{id}`.
